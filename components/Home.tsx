          ...
          <div className="flex flex-col md:flex-row md:items-baseline gap-2 mb-2">
            <h2 className="text-2xl font-bold">
              <button
                ...
                className="text-left w-full after:absolute after:inset-0 hover:underline focus:underline focus:outline-none decoration-2 decoration-gray-300 underline-offset-4"
              >
                {post.title}
              </button>
            </h2>
