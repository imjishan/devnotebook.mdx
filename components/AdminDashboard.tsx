...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div>
        <div className="flex flex-col gap-4 mb-8 border-b border-gray-200 pb-4">
            ...
            {status && (
                <div
                    role="status"
                    className={`text-sm font-mono px-4 py-2 ${status.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}
                >
                    {status.message}
                </div>
            )}
