      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-4">
        ...
        <div className="relative">
          <input
            ...
            className={`w-full border-b-2 py-2 bg-transparent focus:outline-none focus:border-black font-mono text-xl transition-colors pr-10 ${
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-black rounded-sm p-1"
